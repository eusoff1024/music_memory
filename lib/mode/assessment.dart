...
class AssessmentPage extends StatefulWidget {
  ...
  final String userId;
  AssessmentPage({Key? key, required this.userId}) : super(key: key);

  @override
  State<AssessmentPage> createState() => _AssessmentPageState(userId);
}
...
class _AssessmentPageState extends State<AssessmentPage> {
  ...
  _AssessmentPageState(this._userId);
  //URLを保存するリスト
